...
tests = testGroup "all tests" [
    ...
    testGroup "traces" [
        ...
        testProperty "watch funds at an address" walletWatchinOwnAddressV2,
...
{-# DEPRECATED captureTraceOld "Uses old chain index" #-}
captureTraceOld
    :: EmulatorTrace ()
    -> BSL.ByteString
...
{-# DEPRECATED txnValidFromOld "Uses old chain index" #-}
...
{-# DEPRECATED txnUpdateUtxoOld "Uses old chain index" #-}
...
{-# DEPRECATED validTraceOld "Uses old chain index" #-}
...
{-# DEPRECATED validTrace2Old "Uses old chain index" #-}
...
{-# DEPRECATED invalidTraceOld "Uses old chain index" #-}
...
{-# DEPRECATED invalidScriptOld "Uses old chain index" #-}
...
{-# DEPRECATED txnFlowsTestOld "Uses old chain index" #-}
...
{-# DEPRECATED notifyWalletOld "Uses old chain index" #-}
...
{-# DEPRECATED walletWatchinOwnAddressOld "Uses old chain index" #-}
...
walletWatchinOwnAddressV2 :: Property
walletWatchinOwnAddressV2 =
    checkPredicateGenV2 Gen.generatorModel
    (walletWatchingAddress wallet1 (Wallet.walletAddress wallet1))
    (pure ())

{-# DEPRECATED payToPubKeyScriptOld "Uses old chain index" #-}
...
{-# DEPRECATED payToPubKeyScript2Old "Uses old chain index" #-}
